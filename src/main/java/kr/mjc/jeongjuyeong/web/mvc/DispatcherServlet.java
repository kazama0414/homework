...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request,
        ...
        switch (uri) {
            ...
            case "/mvc/article/searchArticle" -> articleController.searchArticle(request, response);
            case "/mvc/article/viewArticle" -> articleController.viewArticle(request, response);
